...
int a1_fakeRatesFromData(double ptCut, double ecaloCut){
  ...
  muFakeControlRegion.Selection( 0 , 0 , true , ptCut , true , true, ecaloCut);
  eleFakeControlRegion.Selection(0 , 0 , true , ptCut , true , true, ecaloCut);
  ...
  TString key = Form("%.0f_%.0f",ptCut,ecaloCut);
  cout<<"key = "<<key<<endl;
  ...
  cout<<"Statisitcs for pt > "<<ptCut<<" and Ecalo < "<<ecaloCut<<endl;
  cout<<"###########################################################################"<<endl;
