...
int makeIasTemplates(double metCut, double jetptCut, double ptCut, double ecaloCut, double iasCut){
  ...
  TString filename = Form("templates/IasTemplate_METGt%.0f_JetPtGt%.0f_trackPtGt%.0f_ECaloEq%.0f.root",metCut,jetptCut,ptCut,ecaloCut);
...
int makeECaloTemplates(double metCut, double jetptCut, double ptCut, double ecaloCut){
  ...
  TString filename = Form("templates/ECaloTemplate_METGt%.0f_JetPtGt%.0f_trackPtGt%.0f.root",metCut,jetptCut,ptCut);
  TFile *out = new TFile(filename,"RECREATE");
  ...
  data.Selection(metCut , jetptCut , true , ptCut , false, 0, 0);
