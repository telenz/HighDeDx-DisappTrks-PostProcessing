...
int getSysUncertainty(double ptCut, double ecaloCut, double iasCut){
  ...
  up.file         =  new TFile("/afs/desy.de/user/t/tlenz/xxl-af-cms/ANALYSIS/workdir/analysis_2015_07_15_JECunc_up/results/analyzer/ntuples/input_weighted/Madgraph_signal_mass_200_ctau_10cm.root","READ");
  down.file       =  new TFile("/afs/desy.de/user/t/tlenz/xxl-af-cms/ANALYSIS/workdir/analysis_2015_07_15_JECunc_down/results/analyzer/ntuples/input_weighted/Madgraph_signal_mass_200_ctau_10cm.root","READ");
  central.file    =  new TFile("/afs/desy.de/user/t/tlenz/xxl-af-cms/ANALYSIS/workdir/analysis_2015_07_15_JECunc_central/results/analyzer/ntuples/input_weighted/Madgraph_signal_mass_200_ctau_10cm.root","READ");
