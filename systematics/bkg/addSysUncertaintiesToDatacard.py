...
fIn = open('1_LeptonScaleFactors/logFiles/electron_ptCutEq%s_ecaloCutEq%s.log' %(ptCut,ecaloCut),'r')
lines = fIn.read().split("\n")
...
fIn = open('3_FakeRate/logFiles/fake_ptCutEq%s_ecaloCutEq%s.log' %(ptCut,ecaloCut) ,'r')
lines = fIn.read().split("\n")
