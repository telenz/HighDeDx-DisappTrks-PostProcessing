...
public:
  ...
  void Selection(bool doKinSelection=false, bool doTrkSelection=false, double ptCut=20, double ecaloCut=5, double iasCut=0.1){
...
int getSysUncertainty(double ptCut, double ecaloCut, double iasCut){
  ...
  fakeSR.Selection(0, 1, ptCut, ecaloCut, iasCut);
  fakeCR.Selection(0, 1, ptCut, ecaloCut, iasCut);
