...
public:
  ...
  void Selection(bool doMatching=false, bool doEcaloCut=false, int pdgId=13, double ptCut=20, double ecaloCut=5){
...
int getSysUncertainty(int pdgId, double ptCut, double ecaloCut){
